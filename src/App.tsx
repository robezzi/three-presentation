    ...
    return (
        <div className='relative h-screen flex'>
            ...
            <div className="z-2 relative w-full h-screen overflow-hidden flex flex-col justify-between pointer-events-none transition-transform duration-[800ms] ease-in-out">
                ...
                <div className='drag'>
                    <svg xmlns="http://www.w3.org/2000/svg" width={40} height={40} viewBox="0 0 24 24" ><g><path d="M0 0h24v24H0z" fill="none" /><path d="M12 2l4.243 4.243-1.415 1.414L12 4.828 9.172 7.657 7.757 6.243 12 2zM2 12l4.243-4.243 1.414 1.415L4.828 12l2.829 2.828-1.414 1.415L2 12zm20 0l-4.243 4.243-1.414-1.415L19.172 12l-2.829-2.828 1.414-1.415L22 12zm-10 2a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm0 8l-4.243-4.243 1.415-1.414L12 19.172l2.828-2.829 1.415 1.414L12 22z" /></g></svg>
                    <p>drag the badge</p>
                </div>
            </div>
        </div>
